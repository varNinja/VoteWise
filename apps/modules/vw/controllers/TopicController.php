...
class TopicController extends ControllerBase
{
    ...
    public function editAction($topicid)
    {
        ...
        if (!$this->request->isPost()) {
            ...
            $this->view->topicid = $topic->topicid;

            $this->tag->setDefault("topicid", $topic->gettopicid());
    ...
    public function createAction()
    {
        ...
        $topic->settopicid($this->request->getPost("topicid"));
    ...
    public function saveAction()
    {
        ...
        $topic = topic::findFirstBytopicid($topicid);
        if (!$topic) {
            $this->flash->error("topic does not exist " . $topicid);
