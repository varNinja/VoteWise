...
module.exports = function(config) {
    ...
    var browserify = {
        ...
        transform: [
            ['browserify-istanbul', {
                ...
                ignore: ['**/*.test.js', '**/*.html', '**/bower_components/**', '**/node_modules/**', '**/public/scripts/lbServices.js']
            }],
            ['babelify', {
                'stage': 0,
    ...
    if (isWebpack) {
        preprocessors = {
            './public/scripts/tests.webpack.js': ['webpack', 'sourcemap']
        };
    } else {
        preprocessors = {
            './public/scripts/**/*.test.js': ['browserify']
        };
    }
    ...
    config.set({
        ...
        files: [
            //'./client/scripts/**/*.html',
            isWebpack ? './public/scripts/tests.webpack.js' : './public/scripts/**/*.test.js'
        ],
